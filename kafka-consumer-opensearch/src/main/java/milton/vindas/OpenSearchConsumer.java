    ...
    public static void main(String[] args) throws IOException {
        ...
        try(openSearchClient; consumer) {
            ...
            while (keepPolling) {
                ...
                // we create a bulk request to send all records at once
                ...
                for (ConsumerRecord<String, String> record: records) {
                    ...
                    try {
                        ...
                        // Strategy: we extract the ID from the JSON value
                ...
                if (bulkRequest.numberOfActions() > 0) {
                    ...
                    try {
                        ...
                        log.error("Interrupted exception in the consumer", e);
                    }

                    // commit the offsets after the batch is consumed
                    consumer.commitSync();
